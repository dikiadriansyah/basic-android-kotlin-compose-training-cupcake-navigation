...
// buat aturan pengujian menggunakan createAndroidComposeRule

    private lateinit var navController: TestNavHostController
/*
Buat instance TestNavHostController sebagai variabel lateinit. Di Kotlin, kata kunci lateinit
digunakan untuk mendeklarasikan properti yang dapat diinisialisasi setelah objek dideklarasikan.
 */

    @Before
    /*
    Anda dapat melakukannya secara otomatis menggunakan anotasi @Before yang disediakan oleh library junit. Jika metode dianotasi dengan @Before, metode tersebut akan berjalan sebelum setiap metode yang dianotasi dengan @Test.
     */
    fun setupCupcakeNavHost(){
        composeTestRule.setContent {
//             panggil metode setContent() pada aturan pengujian Compose yang Anda buat.

            navController = TestNavHostController(LocalContext.current).apply{
                navigatorProvider.addNavigator(ComposeNavigator())
            }
//             membuat objek TestNavHostContoller di class pengujian
